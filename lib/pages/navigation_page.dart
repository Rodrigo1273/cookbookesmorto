...
class _NavigationPageState extends State<NavigationPage> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _pages = [
    {
      'title': 'Home',
      'icon': Icons.home,
      'color': Colors.yellow,  // Cambiado a amarillo
    },
    {
      'title': 'Buscar',
      'icon': Icons.search,
      'color': Colors.purple,  // Cambiado a morado
    },
    {
      'title': 'Perfil',
      'icon': Icons.person,
    ...
    },
    {
      ...
      'icon': Icons.settings,
      'color': Colors.green,  // Cambiado a pino
    },
  ];
  ...
  Widget _buildHomeCard(int index) {
    final cards = [
      {'icon': Icons.analytics, 'title': 'Analytics', 'color': Colors.yellow},
      {'icon': Icons.shopping_cart, 'title': 'Shop', 'color': Colors.purple},
      {'icon': Icons.favorite, 'title': 'Favorites', 'color': Colors.red},
      {'icon': Icons.message, 'title': 'Messages', 'color': Colors.green},
